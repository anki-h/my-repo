...
PROJECT_ID = "famous-robot-451209-g6"
REGION = "us-east1"
CLUSTER_NAME = "my-demo-cluster"
COMPOSER_BUCKET = "us-central1-demo-instance-41728998-bucket"

GCS_JOB_FILE_1 = f"gs://{COMPOSER_BUCKET}/data/INGESTION/mysqlRetailerToLanding.py"
PYSPARK_JOB_1 = {
...
GCS_JOB_FILE_2 = f"gs://{COMPOSER_BUCKET}/data/INGESTION/mysqlSupplierToLanding.py"
PYSPARK_JOB_2 = {
    "reference": {"project_id": PROJECT_ID},
    "placement": {"cluster_name": CLUSTER_NAME},
...
GCS_JOB_FILE_3 = f"gs://{COMPOSER_BUCKET}/data/INGESTION/Untitled.py"
PYSPARK_JOB_3 = {
    "reference": {"project_id": PROJECT_ID},
    "placement": {"cluster_name": CLUSTER_NAME},
...
ARGS = {
    ...
    "email": ["ankitahange2097@gmail.com"],
